...
| House lane (item 8, R12) · disclosure + intro (items 9 + 11) | picked 2026-08-09: the house lane rides next, the words round (9 + 11 + the first invite) right after — order and map in §next round below; vault (items 6–7) on ice with R11 |
