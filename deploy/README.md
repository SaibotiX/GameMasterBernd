...
| Disclosure + intro (items 9 + 11) | the words round rides next (9 + 11 + the first invite) — it writes against R29's re-verified facts; vault (items 6–7) on ice with R11 |
