...
| House lane (item 8, R12/R29) | done (2026-08-09) — gateway + ledger + tripwires + strip + reconciliation, drain test green on production; the played turn seen green 2026-08-09 — the round closes whole (§house-lane state note). Rider: the side-call 401 caught at that turn is fixed (gmchat rides the lane); its lane eyeball (/gm + /history long) rides the words round |
