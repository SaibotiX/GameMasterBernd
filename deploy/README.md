...
| First deploy + eyeball sitting | deploy done, door minted & verified (2026-08-08) — the eyeball sitting is the round's last open item (§first-deploy state note) |
