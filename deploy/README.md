...
| House lane (item 8, R12/R29) | BUILT & LIVE 2026-08-09 — gateway + ledger + tripwires + strip + reconciliation, drain test green on production (§house-lane state note); open: the maintainer's played turn (seen-before-done) |
