...
*Resources. Curated, not exhaustive — each entry says what it's *for*, so you reach for the right one. URLs are stable projects/organizations; if one moves, search its name. Synced: `d700c6e` (2026-08-20).*
