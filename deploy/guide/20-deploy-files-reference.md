...
*Reference. Each entry: what it is · why it exists · how you work with it. The files' own header comments are the deepest truth — most are written as documentation; read them. Synced: `4ba34eb` (2026-08-17).*
