...
| House lane & ledger | ● | R12 (revised 2026-08-08: the only lane) · R29 (2026-08-09: the key-holder — Anthropic direct, prepaid) · [02](02-friends-web-service.md) | gate zero closed 2026-08-09 (R29; at-creation re-verify all-green, [06](06-research-log.md) §2026-08-09) — the BUILD is the open half, map in `deploy/README.md` §next round · Gemini EEA/under-18 facts re-verified 2026-08-08 |
