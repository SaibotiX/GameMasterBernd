...
| House lane & ledger | ● | R12 · R29 · [02](02-friends-web-service.md) item 8 · `deploy/host/gateway/` | BUILT & LIVE 2026-08-09 (gateway, monthly grants, €50-kill/€5-alarm, strip, 04:47 reconciliation — drain test green on production); open: the maintainer's played turn, then telemetry tunes the grant/estimate numbers · Gemini EEA/under-18 facts re-verified 2026-08-08 |
