...
| Working-law portability (the template's law pack) | ● | R32 · the template's `CLAUDE.md` + `records/` + its `/law-sync` (adoption entry R1 there) | landed 2026-08-17, every stamp at the R32 commit · first real sync grades the map · a third adopting project reopens the home question |
