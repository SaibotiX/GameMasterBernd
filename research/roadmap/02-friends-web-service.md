...
- Media telemetry is real (R23's sequencing ruling): stage-1 sessions include actual `/content` casts — images, and at least a handful of video — so the premium-credit pricing in [03-public-launch.md](03-public-launch.md) is re-derived from measurement, not estimate.
