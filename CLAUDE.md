...
| `research/hub/` | the many-projects hub (one box, many doors): decided architecture, tenant wiring workflow, phased build plan — design record awaiting its H0 rulings; once built, live-ops truth is `deploy/README.md` |
