...
| `research/hub/` | a pointer stub only — the hub's design home migrated wholesale at M0 (2026-08-20, R35/R36) to the **World Console** repo (`~/Desktop/CurrPC/Programming/WorldConsole`, its `hub/` + `records/`); the hub's questions are answered THERE. The live box stays this repo's runbook's truth until the H1 ingress cutover |
